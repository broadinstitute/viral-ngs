...
class MafftTool(core.Tool):
    ...
    def execute(
        ...
        if len(inputFiles) > 1:
            ...
            tempCombinedInputFile = file.mkstempfname('__combined.{}'.format(tempFileSuffix))
        ...
        tool_cmd.extend(["--thread", "{}".format(misc.sanitize_thread_count(threads))])
        ...
        with open(outFile, 'w') as outf:
            misc.run_and_save(tool_cmd, outf=outf)
