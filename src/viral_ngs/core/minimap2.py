...
class Minimap2(Tool):
    ...
    def idxstats(self, inReads, refDb, outIdxstats, outReadlist=None, threads=None):
        ...
        if not ref_lengths:
            ...
            with util_file.open_or_gzopen(outIdxstats, 'wt') as outf:
                pass  # write empty file
            if outReadlist:
                with util_file.open_or_gzopen(outReadlist, 'wt') as outf:
                    pass  # write empty file
            return
        ...
        readlist_file = util_file.open_or_gzopen(outReadlist, 'wt') if outReadlist else None
