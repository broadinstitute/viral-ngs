...
def generate_splitcode_config_and_keep_files(
    ...
    config_file = util_file.mkstempfname(f'splitcode_{pool_id}_config.txt')
    ...
    keep_file = util_file.mkstempfname(f"splitcode_{pool_id}_keepfile.txt")
    sample_library_ids = []
