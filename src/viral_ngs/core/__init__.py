'''Core module containing Tool base classes, utilities, and bioinformatics tool wrappers.

This module consolidates what was previously in tools/ and util/ directories.
'''
...
# Import submodules to make them accessible as viral_ngs.core.file, etc.
# Note: version must be imported before cmd because cmd uses version at module level
from . import version
from . import misc
from . import file
from . import stats
