...
class Bwa(Tool):
    ...
    def align_mem_bam(self, inBam, refDb, outBam, options=None,
        ...
        if len(rgs) == 0:
            ...
            with concurrent.futures.ProcessPoolExecutor(max_workers=workers) as executor:
                futures = []# executor.submit(util_file.count_occurrences_in_tsv, filePath, include_noise=includeNoise) for rg in rgs]
    ...
    def align_mem_one_rg(self, inBam, refDb, outBam, rgid=None, options=None,
        ...
        #with util_file.tempfname('.aligned.bam') as tmp_bam_aligned:
    ...
    def mem(self, inReads, refDb, outAlign, options=None, min_score_to_filter=None,
        ...
        if min_score_to_filter:
            ...
            aln_sam_filtered = util_file.mkstempfname('.sam')
