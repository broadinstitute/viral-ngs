...
task deplete_taxa {
  ...
  command {
    ...
    mem_in_mb_50=`/opt/viral-ngs/source/docker/calc_mem.sh mb 50`
    mem_in_mb_90=`/opt/viral-ngs/source/docker/calc_mem.sh mb 90`
...
task filter_to_taxon {
  ...
  command {
    ...
    # find 90% memory
    mem_in_mb=`/opt/viral-ngs/source/docker/calc_mem.sh mb 90`
