...
class StubGenome:
	''' This is a mock genome that should satisfy very simple functions in util_vcf
...
class TestGenomePosition(unittest.TestCase):
	...
	def test_fail_OOB_get_gpos(self):
		...
		invalids = [('SDF',0),('SDF',124),('ASDF',-1),('lala',48),('lala',200),('sdf',80),('la',2),(None,3)]
		gmap = util_vcf.GenomePosition(genome)
		for c,p in invalids:
	...
	def test_spotcheck_edges(self):
		genome = StubGenome([('SDF',123), ('ASDF',256), ('lala',47)])
		knowns = [('SDF',1,1), ('SDF',123,123), ('ASDF',1,124), ('ASDF',256,379), ('lala',1,380), ('lala',47,426)]
		gmap = util_vcf.GenomePosition(genome)
...
class TestVcfReaderPositions(unittest.TestCase):
	...
	def test_sample_names(self):
		...
		vcfdb = util_vcf.VcfReader(self.vcf_fname)
