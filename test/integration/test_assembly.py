...
class TestAssemble(TestCaseWithTmp):
    ...
    def test_ref_assisted_assembly(self):
        ...
        # run refine_assembly
        args = [
            refGenome, inBam, outFasta, "--chr_names", 'G5012.3', "--min_coverage", '3', "--novo_params",
...
class TestOrderOrientAndImputeFromReference(TestCaseWithTmp):
    ...
    def setUp(self):
        ...
        assembly.order_and_orient(
            os.path.join(self.inDir, 'contigs.influenza.fasta'), self.refFasta, self.outOrientFasta
        )
